...
def create_app(db_path=None) -> Flask:
    ...
    from .routes.agent_projects import bp as agent_projects_bp
    from .routes.agent_changes import bp as agent_changes_bp
    from .routes.agent_comments import bp as agent_comments_bp
    ...
    app.register_blueprint(agent_changes_bp)
    app.register_blueprint(agent_comments_bp)
